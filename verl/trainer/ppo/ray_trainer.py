                ...
                with marked_timer("step", timing_raw):
                    ...
                    with marked_timer("reward", timing_raw, color="yellow"):
                        ...
                        if self.config.reward_model.launch_reward_fn_async:
                            future_reward = compute_reward_async.remote(batch, self.global_steps, self.config, self.tokenizer)
                        else:
                            reward_tensor, format_tensor, correctness_tensor, length_tensor, reward_extra_infos_dict = compute_reward(batch, self.global_steps, self.reward_fn)
                    ...
                    with marked_timer("adv", timing_raw, color="brown"):
                        ...
                        if self.config.reward_model.launch_reward_fn_async:
                            reward_tensor, format_tensor, correctness_tensor, length_tensor, reward_extra_infos_dict = ray.get(future_reward)
